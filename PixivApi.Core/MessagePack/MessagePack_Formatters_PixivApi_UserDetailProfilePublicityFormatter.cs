...
{
    public sealed class UserDetailProfilePublicityFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::PixivApi.UserDetailProfilePublicity>
    {

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::PixivApi.UserDetailProfilePublicity value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
            ...
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<string>(formatterResolver).Serialize(ref writer, value.BirthYear, options);
            ...
            writer.Write(value.Pawoo);
        }

        public global::PixivApi.UserDetailProfilePublicity Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var ____result = new global::PixivApi.UserDetailProfilePublicity();
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        ____result.BirthYear = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<string>(formatterResolver).Deserialize(ref reader, options);
                        break;
                    case 4:
                        ...
                        break;
                    case 5:
                        ____result.Pawoo = reader.ReadBoolean();
                        break;
                    default:
                        reader.Skip();
                        break;
